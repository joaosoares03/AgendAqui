  ...
  const fazerCadastro = async () => {
    ...
    try {
      ...
      Alert.alert(
        ...
        [{ text: 'OK', onPress: () => router.replace('/admin/ResumoFinanceiro') }]
      );
    } catch (error: any) {
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView contentContainerStyle={estilos.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={[estilos.formCard, { backgroundColor: cores.fundoCard, borderColor: cores.borda }]}>
            ...
            <View style={[estilos.inputContainer, { backgroundColor: cores.fundo, borderColor: focusStates['nome'] ? cores.botaoPrimario : cores.borda }]}>
              <Ionicons name="person-outline" size={20} color={focusStates['nome'] ? cores.botaoPrimario : cores.textoSecundario} style={estilos.icon} />
              <TextInput
            ...
            <View style={[
              ...
              { backgroundColor: cores.fundo, borderColor: focusStates['cpf'] ? cores.botaoPrimario : cores.borda },
              cpfValido === false && { borderColor: '#EF4444' },
              cpfValido === true && { borderColor: '#10B981' }
            ]}>
              <Ionicons name="card-outline" size={20} color={cpfValido === false ? '#EF4444' : cpfValido === true ? '#10B981' : (focusStates['cpf'] ? cores.botaoPrimario : cores.textoSecundario)} style={estilos.icon} />
              <TextInput
                style={[estilos.input, { color: cores.textoPrimario }]}
            ...
            <View style={[estilos.inputContainer, { backgroundColor: cores.fundo, borderColor: focusStates['telefone'] ? cores.botaoPrimario : cores.borda }]}>
              <Ionicons name="call-outline" size={20} color={focusStates['telefone'] ? cores.botaoPrimario : cores.textoSecundario} style={estilos.icon} />
              <TextInput
                style={[estilos.input, { color: cores.textoPrimario }]}
            ...
            <View style={[estilos.inputContainer, { backgroundColor: cores.fundo, borderColor: focusStates['email'] ? cores.botaoPrimario : cores.borda }]}>
              <Ionicons name="mail-outline" size={20} color={focusStates['email'] ? cores.botaoPrimario : cores.textoSecundario} style={estilos.icon} />
              <TextInput
                style={[estilos.input, { color: cores.textoPrimario }]}
            ...
            <View style={[estilos.inputContainer, { backgroundColor: cores.fundo, borderColor: focusStates['senha'] ? cores.botaoPrimario : cores.borda, marginBottom: 8 }]}>
              <Ionicons name="lock-closed-outline" size={20} color={focusStates['senha'] ? cores.botaoPrimario : cores.textoSecundario} style={estilos.icon} />
              <TextInput
                style={[estilos.input, { color: cores.textoPrimario }]}
              ...
              />
              <TouchableOpacity onPress={() => setMostrarSenha(!mostrarSenha)} hitSlop={{top:10, bottom:10, left:10, right:10}}>
                <Ionicons name={mostrarSenha ? "eye-off-outline" : "eye-outline"} size={20} color={cores.textoSecundario} />
              </TouchableOpacity>
            </View>
          </View>
