...
export default function MenuAdmin() {
  ...
  const opcoes = [
    {
      label: 'Agenda do Dia',
      icone: <Calendar color={cores.corIconeAcao1} size={28} />,
      rota: '/admin/AgendaDiaria',
      cor: cores.fundoIconeAcao1,
    },
    {
      label: 'Gestão de Agendamentos',
      icone: <ClipboardCheck color={cores.corIconeAcao2} size={28} />,
      rota: '/admin/GestaoAgendamentos',
      cor: cores.fundoIconeAcao2,
    },
    {
      label: 'Resumo Financeiro',
      icone: <BarChart3 color="#C084FC" size={28} />,
      rota: '/admin/ResumoFinanceiro',
      cor: tema === 'escuro' ? '#3B0764' : '#F3E8FF',
    },
    {
      label: 'Novo Funcionário',
      icone: <Ionicons name="person-add-outline" color="#38BDF8" size={26} />,
      rota: '/admin/CadastroFuncionario',
  ...
  return (
    <SafeAreaView style={[estilos.container, { backgroundColor: cores.fundo }]}>
      ...
      <View style={[estilos.header, { backgroundColor: cores.fundoHeader, borderBottomColor: cores.borda }]}>
        ...
        <View>
          <Text style={[estilos.headerSub, { color: cores.textoSecundario }]}>Painel Admin</Text>
        ...
        <View style={estilos.grade}>
          {opcoes.map((op, i) => (
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <View style={[estilos.cardIcone, { backgroundColor: op.cor }]}>
                {op.icone}
              </View>
              <Text style={[estilos.cardLabel, { color: cores.textoPrimario }]}>{op.label}</Text>
      ...
      <View style={[estilos.tabBar, { backgroundColor: cores.tabBar, borderTopColor: cores.borda }]}>
        ...
        <TouchableOpacity style={estilos.tabItem} onPress={() => router.push('/admin/ResumoFinanceiro')}>
