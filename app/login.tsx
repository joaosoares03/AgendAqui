...
export default function Login() {
  ...
  const handleLogin = async () => {
    try {
      ...
      if (!email || !senha) {
        Alert.alert('Campos Incompletos', 'Por favor, preencha seu e-mail e senha.');
        return;
      }
      ...
      Alert.alert('Ops!', error.message || 'Falha ao fazer login. Tente novamente.');
    }
  };
            ...
            <View style={estilos.formContainer}>
              ...
              <View
                style={[
                  ...
                  isFocusedEmail && estilos.inputContainerFocused,
                ]}
              >
                <Ionicons
                  name="mail-outline"
                  size={20}
                  color={isFocusedEmail ? '#3B82F6' : '#94A3B8'}
              ...
              <View
                style={[
                  estilos.inputContainer,
                  isFocusedSenha && estilos.inputContainerFocused,
                ]}
              >
                <Ionicons
                  name="lock-closed-outline"
                  size={20}
                  color={isFocusedSenha ? '#3B82F6' : '#94A3B8'}
                  style={estilos.inputIcon}
                />
                <TextInput
                  style={estilos.input}
